...
/**
 * Распределяет пул проигравших между победителями пропорционально их ставкам.
 * Предусловие: все stake должны быть кратны 10.
 * Особые случаи:
 * - Нет победителей или все ставки = 0: пул не распределяется (деньги сгорают)
 * - Нет проигравших: победители получают 0
 */
